    ...
    <div style={S.wrapper}>
      ...
      <div style={S.content}>
        ...
        <div id="admin-mutacoes" style={S.section}>
          <h2 style={S.h2}>4. Modulo Mutacoes — Simulador Genetico</h2>
          <p style={S.p}>Simulador de cruzamentos geneticos para Tarin (Spinus cucullatus).</p>
          ...
          <h3 style={S.h3}>Base de cruzamentos</h3>
          <p style={S.p}>O sistema possui <strong style={S.strong}>51 cenarios de cruzamento</strong> pre-calculados, incluindo mutacoes puras, portadores, crossing-over (Passepartout) e calculos de probabilidade separados para machos e femeas.</p>
        ...
        <div id="admin-modulos" style={S.section}>
          ...
          <T cols={['Modulo', 'Finalidade']} rows={[
            ...
            ['Mutacoes', 'Simulador genetico — 51 cenarios de cruzamento'],
          ]} />
        </div>
