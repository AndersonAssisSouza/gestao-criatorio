...
const TD = ({ children, highlight, color }) => (
  <td style={{ padding: '12px 16px', fontSize: 13, color: color || (highlight ? '#F2EDE4' : '#D8E8D8'), borderBottom: '1px solid rgba(255,255,255,0.04)', fontFamily: 'inherit', verticalAlign: 'middle', fontWeight: highlight ? 500 : 400 }}>
    {children}
  </td>
)
