...
const STEPS = [
  { num: '1', title: 'Crie sua conta', desc: 'Cadastro rápido, sem cartão. Trial de 7 dias com acesso completo.' },
    ...
    <div className="lp">
      ...
      <section className="lp-section">
        ...
        <div className="lp-stats">
          ...
          <div className="lp-stat">
            <span className="lp-stat__num">7</span>
      ...
      <section className="lp-section lp-section--cta" id="lp-cadastro">
        ...
        <p className="lp-section__sub lp-section__sub--light">
          Teste o PLUMAR por 7 dias, sem compromisso. Seus dados ficam salvos.
        </p>
