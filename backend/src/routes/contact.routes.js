...
// Rate limiting simples em memoria para evitar spam
const submissions = new Map()
const RATE_LIMIT_WINDOW = 60 * 60 * 1000 // 1 hora
const MAX_SUBMISSIONS = 3 // maximo 3 por IP por hora
...
/**
 * POST /api/contact
 * Recebe dados do formulario da landing page e envia por email
 */
