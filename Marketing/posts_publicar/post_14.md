...
**Programado:** 2026-05-06 (quarta) 20:00 BRT.
**Plataforma:** Instagram Feed + Facebook Page + WhatsApp (grupos).
**Formato:** Imagem estática.
**Mídia:** `frontend/public/marketing/PLUMAR_Post14_Urgencia.png`
...
## Mensagem WhatsApp (grupos de criadores)
...
- [ ] Definir data de corte concreta (ex: 2026-05-09 23:59) e substituir [DATA DE CORTE] em todas as mensagens
- [ ] Postar no feed antes de mandar nos grupos (regra anti-spam: ter o post público de referência)
- [ ] Disparar nos grupos WhatsApp em horário comercial do dia seguinte (2026-05-07 pela manhã)
