# =============================================================
# PLUMAR — Push dos arquivos restantes (comercial.html e contact.routes.js)
# Execute no PowerShell: .\push_remaining_files.ps1
# =============================================================

Write-Host "`n[PLUMAR] Iniciando push dos arquivos restantes..." -ForegroundColor Cyan
